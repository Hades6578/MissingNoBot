...
if(message.content.includes("Fail","fail")){
        message.reply("Epic Embedded Fail. Laugh at this user.");
    }
    if(message.content.includes("Vaporeon")){
        message.reply("Hey guys, did you know that Vaporeon......");
    }
    if(message.content.includes("cock")){
        message.reply("I sure hope you're talking about chicken.");
    }
    if(message.content.includes("nipple rings")){
        message.reply("haha fire in the hole.");
    }
    if(message.content.includes("Candace")){
        message.reply("Candace nuts fit in yo mouth?");
    }
